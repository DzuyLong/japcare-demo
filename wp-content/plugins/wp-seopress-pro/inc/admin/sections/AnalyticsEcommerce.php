...
<p><?php _e('Track your ecommerce metrics with Google Enhanced Ecommerce.', 'wp-seopress-pro'); ?>
</p>

<p class="seopress-help">
    <a href="<?php echo $docs['analytics']['ecommerce']; ?>"
        target="_blank">
        <?php _e('Learn how to setup Google Enhanced Ecommerce', 'wp-seopress-pro'); ?>
    </a>
