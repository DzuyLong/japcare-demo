            ...
            'settings' => array(
                ...
                'earn_point' => array(
                    ...
                    'user_display_conditions' => array(
                        ...
                        'options' => array(
                            array(
                                'label' => __('User role', 'wp-loyalty-rules'),
                                'value' => 'user_role',
                            ),
                            array(
                                'label' => __('User level', 'wp-loyalty-rules'),
                                'value' => 'user_level',
                            ),
                            array(
                ...
                'pages' => array(
                    ...
                    'show_transaction_section' => array(
                        "name" => __('Show Transaction section', 'wp-loyalty-rules'),
                    ),
                    'show_campaign_point_display' => array(
                        "name" => __('Show Campaign Point display', 'wp-loyalty-rules'),
                    ),
                ),
