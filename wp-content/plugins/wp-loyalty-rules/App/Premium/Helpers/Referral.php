    ...
    function applyReferralEarnCampaign($action_data)
    {
        ...
        foreach ($cart_action_list as $action_type) {
            ...
            foreach ($variant_reward as $campaign_id => $v_reward) {
                if (isset($v_reward['advocate']['point']) && !empty($v_reward['advocate']['point']) && $v_reward['advocate']['point'] > 0 && isset($action_data['advocate_email']) && !empty($action_data['advocate_email'])) {
                ...
                if (isset($v_reward['advocate']['coupon']) && $v_reward['advocate']['coupon']) {
